...
const Privacy: NextPage = () => (
  <Layout>
    <Stack py={5}>
      ...
      <Typography variant="caption">Last updated Nov 24, 2021</Typography>
      {/* the following is generated from https://www.termsfeed.com/privacy-policy-generator/ */}
      <p>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Cookbook.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Cookbook, accessible from{' '}
            <MuiLink href="/" rel="external nofollow noopener" target="_blank">
              cookbook.com
            </MuiLink>
          </p>
        </li>
      ...
      <p>
        ...
        information may be transferred to &ndash; and maintained on &ndash;
      ...
      <ul>
        <li>
          By email:{' '}
          <MuiLink href="mailto:mazeika.t@northeastern.edu">
            mazeika.t@northeastern.edu
          </MuiLink>
        </li>
      </ul>
    </Stack>
